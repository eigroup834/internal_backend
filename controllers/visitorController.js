  ...
  try {
    ...
    const q = `
      ...
      SELECT
        ...
        (SELECT TOP 1 OUTCOME FROM dbo.[${TABLES.VISITOR_CONTACT_LOG}] WHERE CONTACT_CODE=c.CONTACT_CODE AND OUTCOME IS NOT NULL ORDER BY CREATED_DATE DESC) AS LAST_OUTCOME
      INTO #FU
      FROM dbo.[${TABLES.VISITOR_BATCH_CONTACT}] c
      ${PERSON_JOINS}
